...
import type { PolrLoggingOptions } from "../types/options";
...
export interface PolrInternalLogger extends pino.Logger {
...
export function getDefaultLoggerOptions(
  logging: Pick<PolrLoggingOptions, "level"> | undefined,
): pino.LoggerOptions {
  return {
...
export function createPolrLogger(
  ...
  return new Proxy(base, handler) as PolrInternalLogger;
}
